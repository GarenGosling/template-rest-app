...
import org.garen.template.swagger.model.Order;
...
public interface StoreApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful template", response = Integer.class) })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful template", response = Order.class),
